...
{
    Write-Output "Poligon requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "Poligon blockchain .\Install.ps1 complete."
Write-Output ""
Write-Output "To install the GUI type '.\Install-gui.ps1' after '.\venv\scripts\Activate.ps1'."
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'poligon init' to begin."
