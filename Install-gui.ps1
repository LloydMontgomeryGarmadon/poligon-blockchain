...
{
    Write-Output "This script requires that the Poligon Python virtual environment is activated."
...
Push-Location
try {
    Set-Location poligon-blockchain-gui
    ...
    Write-Output ""
    Write-Output "Poligon blockchain Install-gui.ps1 completed."
    Write-Output ""
    Write-Output "Type 'cd poligon-blockchain-gui' and then 'npm run electron' to start the GUI."
} finally {
    Pop-Location
}
