...
# the output will be printed to your chia root path, e.g. ~/.bpx/mainnet/profile/
# to analyze the profile, run:

#   python chia/utils/profiler.py ~/.bpx/mainnet/profile | less -r
...
#   python chia/utils/profiler.py ~/.bpx/mainnet/profile 10 20
