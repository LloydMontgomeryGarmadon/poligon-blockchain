...
# the output will be printed to your chia root path, e.g. ~/.poligon/mainnet/profile/
# to analyze the profile, run:

#   python chia/utils/profiler.py ~/.poligon/mainnet/profile | less -r
...
#   python chia/utils/profiler.py ~/.poligon/mainnet/profile 10 20
