...
# the output will be printed to your chia root path, e.g. ~/.floteo/mainnet/profile/
# to analyze the profile, run:

#   python chia/utils/profiler.py ~/.floteo/mainnet/profile | less -r
...
#   python chia/utils/profiler.py ~/.floteo/mainnet/profile 10 20
