...
@click.option("--testnet", is_flag=True, help="Configure this Poligon install to connect to the testnet")
...
def init_cmd(ctx: click.Context, create_certs: str, fix_ssl_permissions: bool, testnet: bool, v1_db: bool, **kwargs):
    ...
    - Make a copy of your Farming Machine CA directory: ~/.poligon/[version]/config/ssl/ca
    - Shut down all chia daemon processes with `poligon stop all -d`
    - Run `poligon init -c [directory]` on your remote harvester,
