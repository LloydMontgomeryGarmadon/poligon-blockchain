    ...
    with lock_and_load_config(root_path, "config.yaml") as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "28011"
                testnet_introducer = "introducer-testnet10.poligonblockchain.pl"
                testnet_dns_introducer = "dns-introducer-testnet10.poligonblockchain.pl"
                bootstrap_peers = ["testnet10-node.poligonblockchain.pl"]
                testnet = "testnet10"
                ...
                mainnet_port = "55511"
                mainnet_introducer = "introducer.poligonblockchain.pl"
                mainnet_dns_introducer = "dns-introducer.poligonblockchain.pl"
                bootstrap_peers = ["node.poligonblockchain.pl"]
                net = "mainnet"
        ...
        if change_made:
            print("Restart any running Poligon services for changes to take effect")
