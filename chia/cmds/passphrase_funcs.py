    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other Floteo processes will be able to access your keys without prompting for your passphrase."
            )
...
def read_passphrase_from_file(passphrase_file: TextIOWrapper) -> str:
    passphrase = passphrase_file.read().rstrip(os.environ.get("FLOTEO_PASSPHRASE_STRIP_TRAILING_CHARS", "\r\n"))
