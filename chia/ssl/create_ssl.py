...
def generate_ca_signed_cert(ca_crt: bytes, ca_key: bytes, cert_out: Path, key_out: Path):
    ...
    new_subject = x509.Name(
        [
            x509.NameAttribute(NameOID.COMMON_NAME, "Floteo"),
            x509.NameAttribute(NameOID.ORGANIZATION_NAME, "Floteo"),
    ...
    cert = (
        ...
        .add_extension(
            x509.SubjectAlternativeName([x509.DNSName("floteoblockchain.pl")]),
            critical=False,
        )
