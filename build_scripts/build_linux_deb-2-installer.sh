...
if [ "$PLATFORM" = "arm64" ]; then
  ...
  echo USE_SYSTEM_FPM=true electron-builder build --linux deb --arm64 \
    ...
    --config.deb.packageName="poligon-blockchain"
...
GUI_DEB_NAME=poligon-blockchain_${POLIGON_INSTALLER_VERSION}_${PLATFORM}.deb
mv "dist/${PRODUCT_NAME}-${POLIGON_INSTALLER_VERSION}.deb" "../../../build_scripts/dist/${GUI_DEB_NAME}"
